...
arm-none-eabi-objcopy -I binary st_ai_output/yolo_detector_data.xSPI2.bin --change-addresses 0x70C00000 -O ihex yolo_detector_data.hex
...
arm-none-eabi-objcopy -I binary st_ai_output/face_landmark_data.xSPI2.bin --change-addresses 0x70E00000 -O ihex face_landmark_data.hex
