stedgeai generate --no-inputs-allocation --name palm_detector --model 033_palm_detection_full_quant_pc_uf_od.tflite --target stm32n6 --st-neural-art palm_detector@user_neuralart.json
