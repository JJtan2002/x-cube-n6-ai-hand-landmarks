...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(palm_detector) // Defines NN_Instance_palm_detector and NN_Interface_palm_detector with network.c info

AI_ALIGNED(32)
static ai_u8 activations_1[0];
AI_ALIGNED(32)
static ai_u8 activations_2[262144];
AI_ALIGNED(32)
...
AI_ALIGNED(32)
static ai_u8 weights_6[1122705];
AI_ALIGNED(32)
