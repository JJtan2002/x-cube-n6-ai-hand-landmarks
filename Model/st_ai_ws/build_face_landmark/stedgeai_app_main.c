...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(face_landmark) // Defines NN_Instance_face_landmark and NN_Interface_face_landmark with network.c info
