...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(hand_landmark) // Defines NN_Instance_hand_landmark and NN_Interface_hand_landmark with network.c info

AI_ALIGNED(32)
static ai_u8 activations_1[0];
AI_ALIGNED(32)
static ai_u8 activations_2[186368];
AI_ALIGNED(32)
...
AI_ALIGNED(32)
static ai_u8 weights_6[3324385];
